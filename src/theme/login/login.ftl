<#import "template.ftl" as layout>
    <@layout.registrationLayout displayMessage=true displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
        <#if section="form">
            <#if properties["enableX509Login"] == "true">
                <form id="kc-form" action="${url.loginAction}" method="post">
                    <!-- Dynamic content is added by JavaScript -->
                </form>
            </#if>
            <#if realm.password && properties["enableUsernamePasswordAuth"] == "true">
            ...
            <#if realm.password && social?? && social.providers?has_content && properties["enableSocialLogin"] == "true">
            ...
            <#if properties["enableRegisterButton"] == "true">
    ...
    (function () {
        ...
        } else if('${properties["enableX509Login"]}' == "true" && '${properties["enableSocialLogin"]}' == "false" && '${properties["enableUsernamePasswordAuth"]}' == "false"){
            // No CAC detected
